...
from portal.models import Assignments, Students_Model, Teachers_Model, Assignemnt_Submissions, Fees_Model
    ...
    if 'stdnt_usr' in request.session:
        ...
        if request.method == "GET":
            ...
            if len(Fees_Model_data) > 0:
                ...
                return render(request, 'student/stdnt_payment_page.html', context)
            else:
                return "{NOt Valid}"
