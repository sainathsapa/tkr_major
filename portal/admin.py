...
from portal.models import Students_Model, Teachers_Model, Assignments, Assignemnt_Submissions, Plagarized, Fees_Model, accounts_usr, Payments_Model,Notices_Model,Books_Model,Library_User_Model,Book_Issue_Model,Attendance_model, Parent_Model
# Register your models here.
admin.site.register(Students_Model)
admin.site.register(Parent_Model)
