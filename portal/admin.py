...
from portal.models import Students_Model, Teachers_Model, Assignments, Assignemnt_Submissions, Plagarized, Fees_Model, accounts_usr, Payments_Model,Notices_Model,Books_Model,Library_User_Model
